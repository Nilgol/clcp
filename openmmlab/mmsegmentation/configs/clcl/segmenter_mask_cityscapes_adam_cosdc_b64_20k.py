### Base config for finetuning on Cityscapes
### using AdamW Optimizer and different param scheduler (inspired by Segformer settings)
...
val_interval = train_iterations // 5
...
param_scheduler = [
    dict(type='LinearLR',
         ...
         by_epoch=False,
         begin=0,
         end=train_iterations//10),
    dict(type='CosineAnnealingLR',
         T_max=train_iterations - (train_iterations//10),
         eta_min=1e-5,
         by_epoch=False,
         begin=train_iterations//10,
