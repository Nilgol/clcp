...
backbone_checkpoint_path = '/homes/math/golombiewski/workspace/data/models/liploc_combined_vit_small_patch16_224.pth'
    ...
    vis_backends=[dict(type='LocalVisBackend'),
                  dict(type='WandbVisBackend',
                       init_kwargs=dict(
                           ...
                           name='ft_liploc_combined_b64_adamw_cosdc_20k'
                            )
                        )
                    ]
)