...
def get_embeddings(batch_size, embed_dim, mode='random'):
    if mode == 'same_random':
        ...
        base_embeddings = torch.arange(batch_size * embed_dim).float().view(batch_size, embed_dim)
...
if __name__ == "__main__":
    ...
    for mode in ['same_random', 'disturbed', 'random', 'one_to_all']:
        ...
        loss, logits, loss_i, loss_l = contrastive_loss(image_embeddings, lidar_embeddings, temperature)
